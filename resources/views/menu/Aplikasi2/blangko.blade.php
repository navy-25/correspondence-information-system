...
<table border=1 style="width:420px">      
    <tr>
        <td style="height:30px;padding-left:5px;width:100px;border: none;"   valign="top">
            <b>Nama</b>
        </td>
        <td colspan=2  style="height:30px;padding-left:5px;width:10px;border: none;"  valign="top">
            : {{ $ptsp->nama }}
        </td>
        <td rowspan=9 style="height:30px;padding-left:5px;width:140px;border: none;" valign="top">
            @if($ptsp->foto == null)
                <img src="img/default.png" alt="" width="100%" style="background-color:#414141">
            @else
                <img src="{{'file/foto/'.$ptsp->foto}}" alt=""  width="100%">
            @endif
        </td>
    </tr>      
    <tr>
