...
@endsection 
@section('brand')
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href=""><i class="ni ni-single-copy-04" style="margin-right:10px"></i>Agenda Surat Masuk</a>       
@endsection
...
<div class="row" style="margin-bottom:10px">
    <div class="col-xl-3 col-md-6 col-sm-12">
        <a href="{{route('ag_sm')}}" class="btn btn-success" style="margin-bottom:10px;padding:2px;width:100%">
    ...
    <div class="col-xl-3 col-md-6 col-sm-12">
        <a   href="{{route('ag_sp')}}" class="btn btn-light" style=";margin-bottom:10px;padding:2px;width:100%">
...
<div class="card"  style="margin-bottom:15px">
    <div class="card-body">
        <form method="GET" action="{{route('exportDokumen')}}">
            <!-- @csrf -->
            <div class="row">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-7 col-md-6 col-sm-12" style="margin-bottom:10px">
                <h1 class="card-title"> <i class="ni ni-single-copy-04" style="margin-right:10px"></i>Agenda Surat Masuk</h1>              
            </div>
        ...
        <table class="table align-items-center">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" style="width:15%">No. Agenda/Register</th>
                    <th scope="col" style="width:15%">No Surat  </th>
                    <th scope="col" style="width:15%">Tanggal Surat Masuk</th>
                    <th scope="col" style="width:45%">Perihal</th>
