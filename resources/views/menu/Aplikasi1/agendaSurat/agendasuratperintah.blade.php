...
@section('tittle')
    Agenda Surat Perintah
@endsection 
@section('sidebar-agenda-surat')
    active
@endsection 
@section('brand')
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Agenda Surat Perintah</a>       
@endsection
...
<div class="row" style="margin-bottom:10px">
    ...
    <div class="col-xl-3 col-md-6 col-sm-12">
        <a   href="{{route('ag_sr')}}" class="btn btn-success" style=";margin-bottom:10px;padding:2px;width:100%">
...
<div class="card"  style="margin-bottom:15px">
    <div class="card-body">
        <form method="GET" action="{{route('exportDokumen_sr')}}">
            <!-- @csrf -->
            <div class="row">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-xl-7 col-md-6 col-sm-12" style="margin-bottom:10px">
                <h1 class="card-title"> <i class="ni ni-notification-70" style="margin-right:10px"></i>Agenda Surat Perintah</h1>              
            </div>
